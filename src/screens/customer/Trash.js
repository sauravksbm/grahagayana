import { View, Text, Alert, ToastAndroid, ScrollView, StyleSheet, Pressable,FlatList } from 'react-native'
      ...
      {trashNotes.length > 0 && (
        <>
          <View style={{ flexDirection: "row", alignItems: "center", marginVertical: 20, marginHorizontal: 20 }}>
            <Text style={{ color: colors.background_theme2, fontWeight: "600", fontSize: 15 }}>{trashNotes.length} note{trashNotes.length > 1 && 's'} in trash</Text>
            <Pressable
