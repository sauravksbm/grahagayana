...
import {api_url, colors, fonts, liked_me} from '../../config/Constants';
            ...
            ListEmptyComponent={()=>{
              return(
                <View style={{flex: 0, height: height*0.5, justifyContent: 'center', alignItems: 'center'}}> 
                  <Text style={{fontSize: 14, color: colors.black_color5, fontFamily: fonts.medium}}>No Data Available</Text>
                </View>
              )
            }}
          />
