...
const Chaturvimshamsha = (props) => {
  ...
  return (
    <View style={{flex: 1}}>
      ...
      <ChartComponent  title='Chaturvimshamsha' png={chartData} planetData={props.route.params.planetData} />
    </View>
  );
};

export default Chaturvimshamsha