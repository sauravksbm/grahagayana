...
import {api2_my_kundali, api_url,delete_kundali,kundali_search, colors, fonts, getFontSize} from '../../config/Constants';
        ...
        {kundliList && (
          <FlatList
            ...
            renderItem={({item, index}) => (
              <TouchableOpacity
                onPress={()=>props.navigation.navigate('showKundli', {data: item,click:'default'})}
                activeOpacity={0.6}
                key={index}
                style={{
                  flex: 1,
                ...
                <View
                  ...
                  <Text style={{color:colors.black_color,borderWidth:2,fontSize:getFontSize(1.6),paddingLeft:12,paddingRight:8,padding:5,borderRadius:width * 0.1,borderColor:'red'}}>{item.customer_name.charAt(0)}</Text>
