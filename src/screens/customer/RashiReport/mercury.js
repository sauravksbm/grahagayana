import {
  ...
  import {api_astrolist1, api_url, colors, fonts,get_HouseReport,get_RashiReport,get_panchang,getFontSize} from '../../../config/Constants';
            ...
            style={{
              ...
              elevation:6
                ...
                <View style={styles.itemContainer}>
                    <Text style={styles.itemText}>{pachang.planet}</Text>
                    <View>
