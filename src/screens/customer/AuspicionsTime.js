...
import { api_url,get_auspicions,get_dailypanchang } from "../../config/Constants";
import RenderHtml from 'react-native-render-html';

const {width, height} = Dimensions.get('screen');

const AuspicionsTime = (props) => {
