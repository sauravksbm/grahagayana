...
const KetuHouse = props => {
    ...
    const renderContent = () => {
        switch (randomNumber) {
            case 1:
                return <Text>{t("ketu_house_1")}</Text>;
            case 2:
                return <Text>{t("ketu_house_2")}</Text>;
            case 3:
                return <Text>{t("ketu_house_3")}</Text>;
            case 4:
                return <Text>{t("ketu_house_4")}</Text>;
            case 5:
                return <Text>{t("ketu_house_5")}</Text>;
            case 6:
                return <Text>{t("ketu_house_6")}</Text>;
            case 7:
                return <Text>{t("ketu_house_7")}</Text>;
            case 8:
                return <Text>{t("ketu_house_8")}</Text>;
            case 9:
                return <Text>{t("ketu_house_9")}</Text>;
            case 10:
                return <Text>{t("ketu_house_10")}</Text>;
            case 11:
                return <Text>{t("ketu_house_11")}</Text>;
            case 12:
                return <Text>{t("ketu_house_12")}</Text>;
