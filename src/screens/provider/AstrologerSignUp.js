          ...
          <ScrollView>
            <View
              ...
              <TouchableOpacity
                  ...
                  <Text
                    style={{
                      ...
                      color: 'grey',
                      fontWeight: 'normal',
                      paddingTop:getFontSize(0.3),
                      paddingBottom:getFontSize(0.3),
                    }}>
                    {date == null
              ...
              <MultipleSelectList 
                  ...
                  closeicon=""
                  inputStyles={{fontSize:14,color:'grey'}}
                  boxStyles={{borderRadius:30,borderColor:'grey'}}
